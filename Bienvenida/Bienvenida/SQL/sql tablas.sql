...
ALTER TABLE CONTABILIDAD ADD CONSTRAINT PK_CONTABILIDAD PRIMARY KEY (ID_CONTA);
ALTER TABLE CONTABILIDAD ADD CONSTRAINT FK_CONTA_EMPLE FOREIGN KEY (REF_EMPLE) REFERENCES EMPLEADOS(ID_EMPLE);
